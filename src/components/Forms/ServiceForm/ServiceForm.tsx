...
export const ServiceForm = ({onNext})=>{
  const fields = [
    { name: 'name', label: 'שם השירות', validation: 'text', type: 'text' },
    { name: 'description', label: 'תיאור', validation: 'text', type: 'text' },
...
const handleFormSubmit = (data) => {
 ...
 //   id: string, businessId:Bussiness,name: string, serviceData: { schedule: string, description:[{title, content},{}]}
    ...
    // </CacheProvider>
    // </>
    <GenericForm fields={fields} onSubmit={handleFormSubmit} canSkipped={true}/>
    )
}